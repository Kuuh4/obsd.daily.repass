...
- Help you review unfinished tasks from previous daily notes
- Bring the right items into today’s note without manual copying
- Support a lightweight, repeatable daily review workflow
- Keep the plugin useful for both task rollover and quick note retrieval

## What it does

- Move unfinished todos from yesterday or earlier days into today’s daily note
- Optionally remove rolled-over items from the source note
- Skip empty todos if desired
- Target specific sections or headings in your daily template
  - If no section is selected, all todos are appended at the end of the note.
  - If a section is selected, only todos under that section are included until the next sibling heading is reached.
